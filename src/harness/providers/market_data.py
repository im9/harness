...
`latest_bar` (most recent OHLCV), `session_calendar` (when the market
is open) — so concrete adapters stay reversible. Phase 1 ships mocks
only; real-vendor adapters live outside the public tree.
"""
