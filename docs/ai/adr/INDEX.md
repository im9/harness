...
| [010](010-help-ui.md) | Help UI — Learning Surface | Proposed | In-app learning reference for chart / securities / analysis terminology. Design-open — content model, delivery surface (drawer vs route), and dashboard cross-links to be refined through a first-slice spike. Distinct from AI chat: Help UI is durable operator-curated knowledge; chat is transient conversation. Privacy: generic terminology OK in repo, operator's personal notes stay in the DB only |
